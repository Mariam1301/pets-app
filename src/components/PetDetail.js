    ...
    <div className="bg-gray-100 mb-4 rounded p-4 shadow-lg flex justify-between items-center">
      ...
      <div className="flex items-center">
        <button 
          ...
          className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded min-w-[120px]">
            Delete
        </button>
        <button 
          className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded min-w-[120px] ml-2"
          onClick={() => navigate(`/edit-pet/${pet.id}`)}>
            Edit
        </button>
        <button 
          onClick={handleNavigateToTracker}
          className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded min-w-[120px] ml-2">
            Location
        </button>
      </div>
    </div>
